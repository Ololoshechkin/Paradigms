...
import static expression.DoubleExpressionTest.*;
...
public class ParserTest {
    ...
    protected final List<List<Util.Op<BinaryOperator<Long>>>> levels = new ArrayList<>();
    ...
    protected void test() {
        for (final Util.Op<TExpression> test : tests) {
